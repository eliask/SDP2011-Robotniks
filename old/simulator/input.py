...
class Input:
    ...
    def mouseInput(self, event):
        ...
        # if self.place_object_num == 0:
        #     print "START"
        #     print self.p1.pos
        #     self.p1.pos = pos
        #     print self.p1.pos
        #     #     self.place_object_num = 1
        #     # elif self.place_object_num == 1:
        #     #     self.p1.orientation = atan2(pos[1] - self.startPos[1],
        #     #                                 pos[0] - self.startPos[0])
        #     self.place_object_num = 2
        # elif self.place_object_num == 2:
        #     print "GOAL"
        #     self.sim.world.ents['ball'].pos = pos
        #     self.sim.world.ents['ball'].velocity = np.array([0,0])
        #     self.place_object_num = 0
            # elif self.place_object_num == 2:
            #     print "OBSTACLE"
